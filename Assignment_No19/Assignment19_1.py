"""
File:        Assignment19_1.py
Author:      Shantanu Kulthe
Date:        10/06/2025
Description: This Application to directory with particular file extenison and display
Interpreter: PVM (Python Virtual Machine)
Platform:    Windows
"""
import os
import sys
def DisplayFile(DirName,extension):
